...
class Settings(BaseSettings):
    ...
    standard_context_chars: int = Field(default=14_000, ge=4_000, le=50_000)
    deep_context_chars: int = Field(default=28_000, ge=4_000, le=50_000)
    read_context_chars: int = Field(default=10_000, ge=4_000, le=50_000)
