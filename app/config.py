...
class Settings(BaseSettings):
    ...
    quick_context_chars: int = Field(default=8_000, ge=4_000, le=50_000)
    standard_context_chars: int = Field(default=9_000, ge=4_000, le=50_000)
    deep_context_chars: int = Field(default=10_000, ge=4_000, le=50_000)
