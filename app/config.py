...
class Settings(BaseSettings):
    ...
    quick_context_chars: int = Field(default=9_000, ge=4_000, le=50_000)
    standard_context_chars: int = Field(default=10_000, ge=4_000, le=50_000)
    deep_context_chars: int = Field(default=12_000, ge=4_000, le=50_000)
    read_context_chars: int = Field(default=8_000, ge=4_000, le=50_000)
    mcp_tool_deadline_seconds: float = Field(default=105.0, ge=30, le=300)
    mcp_repeat_search_cooldown_seconds: float = Field(default=5.0, ge=0, le=60)
